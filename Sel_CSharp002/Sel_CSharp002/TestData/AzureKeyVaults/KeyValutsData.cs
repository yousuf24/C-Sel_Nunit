...
namespace Sel_CSharp002.TestData.AzureKeyVaults
{
    class KeyValutsData
    {
        ...
        public static string sftestServiceManagerUserName => GetVaultsData(KeyVaultsVariables.sftestServiceManagerUserName, KeyVaultsVariables.sectionName);
        public static string sftestServiceManagerPassword => GetVaultsData(KeyVaultsVariables.sftestServiceManagerPassword, KeyVaultsVariables.sectionName);
